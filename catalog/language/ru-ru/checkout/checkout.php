...
// Text
$_['button_continue_without_registering'] = 'Оформить без регистрации';
$_['button_registration']                = 'Регистрация';
...
$_['text_checkout_payment_address']  = 'Шаг 2: Личная информация';
...
$_['text_register_account']          = 'Создание учётной записи поможет делать покупки быстрее и удобнее, не внося одни и те же данные многократно (адрес доставки, имя, телефон и т.д.) Вы также, сможете отслеживать статус своего заказа, видеть свои предыдущие заказы, получить скидку как постоянный покупатель.';
...
$_['text_shipping_city']             = 'Населенный пункт';
$_['text_shipping_post_offices']     = 'Отделение Новой Почты';
