...
class ControllerCheckoutGuest extends Controller {
	...
	public function save() {
		...
		if (!$json) {
			...
			$this->session->data['payment_address']['zone_id'] = array_key_exists('zone_id',$this->request->post) ? $this->request->post['zone_id']: 0;
			...
			// }
			  ...
			  if ($this->session->data['guest']['shipping_address']) {
				...
				$this->session->data['shipping_address']['zone_id'] = array_key_exists('zone_id',$this->request->post) ? $this->request->post['zone_id']: 0;;
