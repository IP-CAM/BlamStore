...
class ControllerCheckoutLogin extends Controller {
    ...
    $data['button_continue_without_registering'] = $this->language->get('button_continue_without_registering');
		$data['button_continue'] = $this->language->get('button_continue');
		$data['button_login'] = $this->language->get('button_login');
		$data['button_registration'] = $this->language->get('button_registration');
