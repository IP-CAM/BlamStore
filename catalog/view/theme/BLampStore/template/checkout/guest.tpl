<div class="row">
  <div class="col-sm-6">
    <fieldset id="account">
      ...
      <div class="form-group required">
        <label class="control-label font-numbers" for="input-payment-telephone"><?php echo $entry_telephone; ?></label>
...
<div class="buttons">
  <div class="pull-left">
    <input type="button" value="<?php echo $button_continue; ?>" id="button-guest" data-loading-text="<?php echo $text_loading; ?>" class="btn" />
  </div>
</div>
